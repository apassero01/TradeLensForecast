...
// import SelectionBox from './Strategy/inputs/SelectionBox';  // For displaying the sequence sets
// import axios from 'axios';  // Import Axios for making API calls
// import qs from 'qs';
// import DateInput from "./inputs/DateInput";  // Import qs for serializing data

// function ConfigurationInputBox({
//                                    sessionState,
//                                    updateSessionState,
//                                    setError,
//                                    setLoading,
...
//             if (sessionState.allModelSets.length === 0) {  // Only fetch if the sequence sets aren't already loaded
//                 const sequenceSets = await fetchSequenceSetsMetaData();
//                 updateSessionState('allModelSets', sequenceSets);
//             }
...
//         loadData();
//     }, [
//         sessionState.allModelSets.length,
...
//         if (sessionState.selectedModelSets.length === 0) {
...
//                 'http://localhost:8000/training_session/start_training_session/',
//                 qs.stringify({
//                     sequence_params: JSON.stringify(sessionState.selectedModelSets),  // Send selected sets
...
//             updateSessionState('sessionData', response.data.sessionData);  // Update session data in parent component
...
//                         items={sessionState.allModelSets}
//                         itemKey="id"
...
//                                 ? [...sessionState.selectedModelSets, set]
//                                 : sessionState.selectedModelSets.filter((s) => s.id !== set.id);
//                             updateSessionState('selectedModelSets', updatedSets);
//                         }}
//                         selectedItems={sessionState.selectedModelSets}
//                     />
//                 </div>
...
//                                 : sessionState.selectedXFeatures.filter((f) => f.name !== feature.name);
...
//                                 : sessionState.selectedYFeatures.filter((f) => f.name !== feature.name);
...
// export default ConfigurationInputBox;