...
class Transformer(nn.Module):
    ...
    def forward(self, encoder_input, decoder_input, target_mask=None):
        ...
        orig_encoder_values = encoder_input.clone()
        decoder_input = self.decoder_input_projection(decoder_input)

        encoder_output = self.encoder(encoder_input)
        decoder_output = self.decoder(decoder_input, encoder_output,orig_encoder_values)
    ...
    def inference(self, encoder_input, start_token, max_len):
        ...
        encoder_output = self.encoder(encoder_input)
        return self.decoder.inference(encoder_output, encoder_input, max_len)
